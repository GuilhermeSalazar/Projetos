...
$consulta = mysqli_query($sql,"SELECT * FROM servico where id = '$id'");
    ...
    echo "
           ...
           <div id='editar-servico' class='modal ' style='display: block;'>
                ...
                <div class='col-lg-5'>
                 <div class='form-group'>
                  <label class='form-control-label'>Descrição:</label>
                    <input type='text' value='".$array_b['servico']."'  class='form-control' name='descri'>
                 </div>
                </div>
