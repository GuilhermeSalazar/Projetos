  ...
  $estatus = $_SESSION['estatus'];
                ...
                while($chatlink = mysqli_fetch_array($busca)){
                        ...
                        if($login == $chatlink['usuario'] ){
                            ...
                            $mensagens = mysqli_fetch_array(mysqli_query($sql,"SELECT * FROM mensagens WHERE d_quem like '$chatnome' && p_quem like '$login' && status = 0  LIMIT 1"));
